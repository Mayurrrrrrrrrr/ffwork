...
<head>
    ...
    <title>BTL Marketing Portal</title>
    <!-- Bootstrap CSS -->
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="portal_home.php">
            ...
            <span class="portal-title">BTL Marketing</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <?php if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true && isset($_SESSION['roles'])): ?>
                    ...
                    <?php if ($can_access_expenses || $can_access_purchase || $can_access_learning): // Show Portal Home if they have access to more than just BTL ?>
                        <li class="nav-item"><a class="nav-link" href="portal_home.php"><i data-lucide="home"></i>Portal Home</a></li>
                    <?php endif; ?>
                    
                    <li class="nav-item"><a class="nav-link" href="btl/index.php"><i data-lucide="layout-dashboard"></i>BTL Dashboard</a></li>

                    <?php // --- BTL SYSTEM LINKS --- ?>
                    <?php if (check_role('employee')): // Any employee can propose an activity ?>
                        <li class="nav-item"><a class="nav-link" href="btl/propose.php"><i data-lucide="plus-circle"></i>New Proposal</a></li>
                    <?php endif; ?>
                    
                    <?php if (has_any_role(['approver', 'marketing_manager', 'admin', 'platform_admin'])): ?>
                        <li class="nav-item"><a class="nav-link" href="btl/index.php"><i data-lucide="check-square"></i>Manage Proposals</a></li>
                    <?php endif; ?>
