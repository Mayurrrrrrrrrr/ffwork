...
$is_data_admin = has_any_role(['data_admin', 'admin', 'platform_admin']); // New role
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="portal_home.php">
            ...
            <span class="portal-title">Tools Portal</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <?php if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true && isset($_SESSION['roles'])): ?>
                    ...
                    <li class="nav-item"><a class="nav-link" href="tools/index.php"><i data-lucide="layout-dashboard"></i>Tools Dashboard</a></li>
                    <!-- UPDATED LINK: ISO is now Stock Transfer -->
                    <li class="nav-item"><a class="nav-link" href="stock_transfer/index.php"><i data-lucide="send"></i>Stock Transfer (ISO)</a></li>
                    <li class="nav-item"><a class="nav-link" href="tools/stocklookup.php"><i data-lucide="search"></i>Stock Lookup</a></li>
                    <li class="nav-item"><a class="nav-link" href="tools/productfinder.php"><i data-lucide="filter"></i>Product Finder</a></li>
                    <li class="nav-item"><a class="nav-link" href="tools/costlookup.php"><i data-lucide="dollar-sign"></i>Cost Lookup</a></li>
                     
                    <?php if ($is_data_admin): ?>
                        <li class="nav-item"><a class="nav-link" href="tools/manage_data.php"><i data-lucide="upload-cloud"></i>Manage Data</a></li>
                    <?php endif; ?>
