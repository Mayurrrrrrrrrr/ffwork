...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="portal_home.php">
            ...
            <span class="portal-title">Purchase System</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <?php if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true && isset($_SESSION['roles'])): ?>
                    ...
                    <?php if ($can_access_expenses || $can_access_btl || $can_access_learning): // Show Portal Home if they have access to more than just purchase ?>
                        <li class="nav-item"><a class="nav-link" href="portal_home.php"><i data-lucide="home"></i>Portal Home</a></li>
                    <?php endif; ?>
                    
                    <li class="nav-item"><a class="nav-link" href="purchase/index.php"><i data-lucide="layout-dashboard"></i>Purchase Dashboard</a></li>

                    <?php // --- PURCHASE SYSTEM LINKS --- ?>
                    <?php if (has_any_role(['sales_team', 'admin', 'platform_admin', 'purchase_head'])): ?>
                        <li class="nav-item"><a class="nav-link" href="purchase/new_request.php"><i data-lucide="plus-circle"></i>New Request</a></li>
                    <?php endif; ?>
                    
                    <?php if (has_any_role(['order_team', 'inventory_team', 'admin', 'platform_admin', 'purchase_head'])): ?>
                        <li class="nav-item"><a class="nav-link" href="purchase/index.php"><i data-lucide="shopping-cart"></i>Manage POs</a></li>
                    <?php endif; ?>

                    <?php // --- Finance & Reports Dropdown ---
                    if (has_any_role(['accounts', 'admin', 'platform_admin', 'purchase_head'])): ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="financeDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i data-lucide="banknote"></i> Finance & Reports
                            </a>
                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="financeDropdown">
                                <li><a class="dropdown-item" href="purchase/accounts_view.php"><i data-lucide="clipboard-check"></i>Accounts View</a></li>
                                <li><a class="dropdown-item" href="purchase/report_accounts_payable.php"><i data-lucide="credit-card"></i>Accounts Payable</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item" href="purchase/pipeline.php"><i data-lucide="git-commit"></i>Pipeline Tracker</a></li>
                                <li><a class="dropdown-item" href="purchase/report_vendor_performance.php"><i data-lucide="bar-chart-3"></i>Vendor Report</a></li>
                                <li><a class="dropdown-item" href="purchase/report_inventory_aging.php"><i data-lucide="archive"></i>Inventory Aging</a></li>
                                <li><a class="dropdown-item" href="purchase/report_qc_failures.php"><i data-lucide="search-x"></i>QC Failure Report</a></li>
                                <li><a class="dropdown-item" href="purchase/report_cycle_time.php"><i data-lucide="timer"></i>Cycle Time Report</a></li>
                            </ul>
                        </li>
                    <?php endif; ?>

                     <?php // --- Settings Dropdown ---
                    if (has_any_role(['admin', 'platform_admin', 'purchase_head'])): ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="settingsDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i data-lucide="settings"></i> Settings
                            </a>
                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="settingsDropdown">
                                <li><a class="dropdown-item" href="purchase/vendors.php"><i data-lucide="truck"></i>Manage Vendors</a></li>
                                <!-- Add other settings links here later -->
                            </ul>
                        </li>
                    <?php endif; ?>
                ...
                <?php else: // Fallback if session is broken ?>
                    <li class="nav-item">
                        <a class="nav-link" href="login.php"><i data-lucide="log-in"></i>Login</a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
