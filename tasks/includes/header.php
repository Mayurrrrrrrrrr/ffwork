...
// For now, any employee can view the task system
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="portal_home.php">
            ...
            <span class="portal-title">Task Tracker</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <?php if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true && isset($_SESSION['roles'])): ?>
                    ...
                    <li class="nav-item"><a class="nav-link" href="tasks/index.php"><i data-lucide="layout-dashboard"></i>Task Dashboard</a></li>

                    <?php if (has_any_role(['approver', 'admin', 'platform_admin', 'purchase_head', 'marketing_manager'])): ?>
                        <li class="nav-item"><a class="nav-link" href="tasks/manage.php"><i data-lucide="plus-circle"></i>Create Task</a></li>
                        <li class="nav-item"><a class="nav-link" href="tasks/pipeline.php"><i data-lucide="git-commit"></i>Task Pipeline</a></li>
                    <?php endif; ?>
